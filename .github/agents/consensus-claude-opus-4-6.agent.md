...
You are the Claude Opus 4.6 slot for the multi-agent consensus workflow.

This agent name is a stable slot identifier. If a higher compatible Claude Opus version becomes the new pinned target, update the `model:` field and keep the slot name unless the workflow contract changes.
