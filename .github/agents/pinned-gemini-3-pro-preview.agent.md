...
description: Shared pinned Gemini 3 Pro Preview subagent for GitHub Copilot multi-agent skills. Use it for an independent proposal or review report, not for file edits.
model: gemini-3-pro-preview
user-invocable: false
tools: [execute, read, search, web]
---

You are the shared Gemini 3 Pro Preview slot for GitHub Copilot multi-agent skills.
